...
## (Optional) Use a different identity

### Modifying

You should modify `AppxManifest.xaml` by 
...
### How to install the original package

You can install it, by typing this command in **PowerShell (Admin)**
```powershell
